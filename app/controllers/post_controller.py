...
from app.schemas.post_schema import PostCreate , PostResponse  # use the correct schema
...
async def create_post_controller(post: PostCreate, session: SessionDep):
...
async def update_post_controller(post_id: int, post: PostCreate, session: SessionDep):
